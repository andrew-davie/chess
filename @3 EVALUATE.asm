...
PositionalValue_BISHOP
    ...
    PVAL -10,   0,  60,  20,  20,  10,   0, -10
    PVAL -10,   5,   5,  20,  20,   5,   5, -10
    PVAL -10,   0,   5,  10,  10,   5,   0, -10
    PVAL -10,   0,   0,   0,   0,   80,   0, -10
...
PositionalValue_ROOK
    ...
    PVAL   -25, -25,  10,  20,  10, 10, -25,  -25
    PVAL  -120,   0,   0,   0,   0,   0,   0, -128
    PVAL  30,   0,   0,   0,   0,   0,   0, 30
    PVAL   40,   0,   0,   0,   0,   0,   0, 40
...
PositionalValue_QUEEN
    ...
    PVAL -10,   0,  25,  25,  25,  25,   0, -10
    PVAL  -5,   0,  60,  55,  55,  55,   0,  -5
